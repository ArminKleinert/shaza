...
ArrayMap!(K, V) assoc(K, V)(ArrayMap!(K, V) am, K key, V value) {
    {
        ...
        return if2(eql_Q(i, -1), new ArrayMap!(K, V)(append(am.keys, key),
                append(am.values, value)), new ArrayMap!(K, V)(clone(keys),
                assoc(am.values, i, values)));
    }
}

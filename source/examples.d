...
auto d = delegate int(int i) { return inc(i); };
...
void call_call_lambda() {
    writeln(call_lambda(delegate int(int i) { return inc(i); }));
}
...
auto anon_params_1(_gensym_637349066722424887, _gensym_637349066722424919)(
        _gensym_637349066722424887 _gensym_637349066722424904,
        _gensym_637349066722424919 _gensym_637349066722424932) {
    return _gensym_637349066722424904 + _gensym_637349066722424932;
}

auto anon_params_2(int _gensym_637349066722426010,
        float _gensym_637349066722426025, int _gensym_637349066722426038) {
...
auto anon_params_nested(int _gensym_637349066722427561) {
    return delegate int() { return _gensym_637349066722427561; };
}
...
auto anon_types_2(_gensym_637349066722428278, _gensym_637349066722428293)(
        _gensym_637349066722428278 i, _gensym_637349066722428293 j) {
    return i + j;
}
...
auto anon_types_4(_gensym_637349066722428437, _gensym_637349066722428453)(
        _gensym_637349066722428437 i, _gensym_637349066722428453 j) {
    return i + j;
}
...
auto foo15() {
    return println_E(delegate(int i) { return plus(i, i); }(5));
}
